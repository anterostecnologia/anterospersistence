...
import br.com.anteros.persistence.sql.converter.Converter;
...
public abstract class AbstractConverter implements Converter {
	...
	protected Object handleError(Class<?> type, Object value, Throwable cause) throws Exception {
		...
		SQLConversionException cex = null;
		if (cause instanceof SQLConversionException) {
			cex = (SQLConversionException) cause;
		} else {
			String msg = "Error converting from '" + toString(value.getClass()) + "' to '" + toString(type) + "' " + cause.getMessage();
			cex = new SQLConversionException(msg + cause.getMessage());
			initCause(cex, cause);
		}
	...
	protected Object handleMissing(Class<?> type) throws SQLConversionException {
		...
		SQLConversionException cex = new SQLConversionException("No value specified for '" + toString(type) + "'");
		throw cex;
