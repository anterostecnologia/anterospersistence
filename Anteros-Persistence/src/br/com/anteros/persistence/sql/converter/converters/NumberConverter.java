	...
	private Number toNumber(Class<?> sourceType, Class<?> targetType, Number value) throws Throwable {
		...
		if (targetType.equals(Byte.class)) {
			...
			if (longValue > Byte.MAX_VALUE) {
				throw new SQLConversionException(toString(sourceType) + " value '" + value + "' is too large for " + toString(targetType));
			}
			if (longValue < Byte.MIN_VALUE) {
				throw new SQLConversionException(toString(sourceType) + " value '" + value + "' is too small " + toString(targetType));
			}
