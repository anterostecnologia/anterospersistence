...
import br.com.anteros.persistence.osql.impl.OperatorImpl;
...
public final class Operators {
	...
	public static final Operator<String> STRING_CAST = new OperatorImpl<String>("STRING_CAST");
	...
	public static final Operator<Object> SINGLETON = new OperatorImpl<Object>("SINGLETON");
	...
	// collection
	public static final Operator<Boolean> IN = new OperatorImpl<Boolean>("IN");
	public static final Operator<Boolean> NOT_IN = new OperatorImpl<Boolean>("NOT_IN");
	public static final Operator<Boolean> COLUMN_IS_EMPTY = new OperatorImpl<Boolean>("COLUMN_IS_EMPTY");
	public static final Operator<Number> COLUMN_SIZE = new OperatorImpl<Number>("COLUMN_SIZE");
	...
	public static final Operator<Number> ROUND2 = new OperatorImpl<Number>("ROUND2");
	...
	public static final Set<Operator<?>> EQUALS_OPERATORS = ImmutableSet.<Operator<?>> of(EQ);
	public static final Set<Operator<?>> NOT_EQUALS_OPERATORS = ImmutableSet.<Operator<?>> of(NE);
	public static final Set<Operator<?>> COMPARE_OPERATORS = ImmutableSet.<Operator<?>> of(EQ, NE, LT, GT, GOE, LOE);
	public static final Set<Operator<?>> AGGREGATION_OPERATORS = ImmutableSet.of(AVG_AGG, COUNT_AGG,
			COUNT_DISTINCT_AGG, MAX_AGG, MIN_AGG, SUM_AGG);
