 ...
 */
package br.com.anteros.persistence.osql.alias;
...
import br.com.anteros.persistence.osql.types.path.ArrayPath;
import br.com.anteros.persistence.osql.types.path.BooleanPath;
import br.com.anteros.persistence.osql.types.path.CollectionPath;
import br.com.anteros.persistence.osql.types.path.ComparableEntityAttribute;
...
import br.com.anteros.persistence.osql.types.path.EntityPathBase;
import br.com.anteros.persistence.osql.types.path.EnumPath;
import br.com.anteros.persistence.osql.types.path.ListPath;
import br.com.anteros.persistence.osql.types.path.MapPath;
import br.com.anteros.persistence.osql.types.path.NumberPath;
import br.com.anteros.persistence.osql.types.path.SetPath;
...
public class DefaultPathFactory implements PathFactory {
    ...
    public <T> Path<T> createEntityPath(Class<T> type, PathMetadata<?> metadata) {
        if (Comparable.class.isAssignableFrom(type)) {
            return new ComparableEntityAttribute(type, metadata);
        } else {
