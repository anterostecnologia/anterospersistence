...
public class JavassistLazyLoadFactory implements LazyLoadFactory {
	...
	public Object createProxy(SQLSession session, Object targetObject, DescriptionField descriptionField,
		...
		if (descriptionField.isLob()) {
			...
			JavassistLazyLoadInterceptor lazyLoadInterceptor = new JavassistLazyLoadInterceptor(session,
					targetEntityCache, columnKeyValues, transactionCache, targetObject, descriptionField);
