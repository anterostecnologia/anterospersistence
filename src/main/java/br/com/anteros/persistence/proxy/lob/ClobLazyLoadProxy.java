...
public class ClobLazyLoadProxy implements InvocationHandler {
	...
	public ClobLazyLoadProxy(SQLSession session, Object owner, EntityCache entityCache, Map<String, Object> columKeyValues, 
	...
	private void initializeClob() throws Exception {
		target = (AnterosClob) session.createQuery("").loadData(entityCache, owner, descriptionFieldOwner, columKeyValues, null);
	...
	public static Clob createProxy(SQLSession session, Object owner, EntityCache entityCache, Map<String, Object> columKeyValues, 
			DescriptionField descriptionFieldOwner) {
