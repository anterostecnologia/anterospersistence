...
public final class Ops {
	...
	// collection
	public static final Operator<Boolean> IN = new OperatorImpl<Boolean>(NS, "IN"); // cmp.
																					// contains
	...
	public static final class DateTimeOps {
		...
		public static final Operator<Comparable> CURRENT_TIMESTAMP = new OperatorImpl<Comparable>(NS,
				"CURRENT_TIMESTAMP");
