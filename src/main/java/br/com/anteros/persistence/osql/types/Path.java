...
/**
 * Path represents a path expression. Paths refer to variables, properties and
 * collection members access.
 * 
 * @author tiwe
 */
public interface Path<T> extends Expression<T> {
	 ...
	 * related field and/or getter method and for all others paths the annotated
	 * element is the expression type.
	 * </p>
	 *
	 * @return
	 */
