...
/**
 * Expression defines a general typed expression in a Query instance. The
 * generic type parameter is a reference to the type the expression is bound to.
 * 
 * <p>
 * The central Expression subinterfaces are
 * </p>
 * <ul>
 * <li>{@link Constant} - for constants such as Strings, numbers and entity
 * instances</li>
