...
/**
 * Converters provides expression converters for lower case, upper case and
 * prefix/suffix conversions
 *
 * @author tiwe
 *
 */
			...
			new Function<Object, Object>() {
				...
				public Object apply(Object arg) {
					if (arg instanceof Constant) {
						...
						Expression<String> concated = OperationImpl.create(String.class, Ops.CONCAT, (Expression) arg,
								PERCENT);
			...
			new Function<Object, Object>() {
				...
				public Object apply(Object arg) {
					if (arg instanceof Constant) {
						...
						Expression<String> concated = OperationImpl.create(String.class, Ops.CONCAT, PERCENT,
								(Expression) arg);
						return OperationImpl.create(String.class, Ops.LOWER, concated);
					} else {
						return "%" + escapeForLike(arg.toString().toLowerCase(Locale.ENGLISH));
