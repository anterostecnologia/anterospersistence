...
import br.com.anteros.persistence.osql.QueryException;

import com.google.common.collect.ImmutableList;

/**
 * ExpressionUtils provides utilities for constructing common operation
 * instances. This class is used internally in Querydsl and is not suitable to
 * be used in cases where DSL methods are needed, since the Expression
 * implementations used in this class are minimal internal implementations.
 *
 * @author tiwe
 *
 */
public final class ExpressionUtils {
	...
	/**
	 * Create an alias expression (source as alias) with the given source and
	 * alias
	 *
	 * @param <D>
	 * @param source
