...
import br.com.anteros.persistence.osql.types.Templates;
 ...
 * @author tiwe
 */
public class OSQLTemplates extends Templates {

    public static final Expression<?> RECURSIVE = TemplateExpressionImpl.create(Object.class, "");

    public static final OSQLTemplates DEFAULT = new OSQLTemplates("\"",'\\',false);
    ...
    public abstract static class Builder {
        ...
        protected abstract OSQLTemplates build(char escape, boolean quote);

        public OSQLTemplates build() {
            OSQLTemplates templates = build(escape, quote);
    ...
    protected OSQLTemplates(String quoteStr, char escape, boolean useQuotes) {
        super(escape);
        ...
        // flags
        add(OSQLOps.WITH_ALIAS, "{0} as {1}", 0);
        add(OSQLOps.WITH_COLUMNS, "{0} {1}", 0);
        add(OSQLOps.FOR_UPDATE, "\nfor update");
        add(OSQLOps.FOR_SHARE, "\nfor share");
        add(OSQLOps.NO_WAIT, " nowait");
        add(OSQLOps.QUALIFY, "\nqualify {0}");
        ...
        add(OSQLOps.CAST, "cast({0} as {1s})");
        add(OSQLOps.UNION, "{0}\nunion\n{1}", 50);
        add(OSQLOps.UNION_ALL, "{0}\nunion all\n{1}", 50);
        add(OSQLOps.NEXTVAL, "nextval('{0s}')");

        // analytic functions
        add(OSQLOps.CORR, "corr({0},{1})");
        add(OSQLOps.COVARPOP, "covar_pop({0},{1})");
        add(OSQLOps.COVARSAMP, "covar_samp({0},{1})");
        add(OSQLOps.CUMEDIST, "cume_dist()");
        add(OSQLOps.CUMEDIST2, "cume_dist({0})");
        add(OSQLOps.DENSERANK, "dense_rank()");
        add(OSQLOps.DENSERANK2, "dense_rank({0})");
        add(OSQLOps.FIRSTVALUE, "first_value({0})");
        add(OSQLOps.LAG, "lag({0})");
        add(OSQLOps.LASTVALUE, "last_value({0})");
        add(OSQLOps.LEAD, "lead({0})");
        add(OSQLOps.LISTAGG, "listagg({0},'{1s}')");
        add(OSQLOps.NTHVALUE, "nth_value({0}, {1})");
        add(OSQLOps.NTILE, "ntile({0})");
        add(OSQLOps.PERCENTILECONT, "percentile_cont({0})");
        add(OSQLOps.PERCENTILEDISC, "percentile_disc({0})");
        add(OSQLOps.PERCENTRANK, "percent_rank()");
        add(OSQLOps.PERCENTRANK2, "percent_rank({0})");
        add(OSQLOps.RANK, "rank()");
        add(OSQLOps.RANK2, "rank({0})");
        add(OSQLOps.RATIOTOREPORT, "ratio_to_report({0})");
        add(OSQLOps.REGR_SLOPE, "regr_slope({0}, {1})");
        add(OSQLOps.REGR_INTERCEPT, "regr_intercept({0}, {1})");
        add(OSQLOps.REGR_COUNT, "regr_count({0}, {1})");
        add(OSQLOps.REGR_R2, "regr_r2({0}, {1})");
        add(OSQLOps.REGR_AVGX, "regr_avgx({0}, {1})");
        add(OSQLOps.REGR_AVGY, "regr_avgy({0}, {1})");
        add(OSQLOps.REGR_SXX, "regr_sxx({0}, {1})");
        add(OSQLOps.REGR_SYY, "regr_syy({0}, {1})");
        add(OSQLOps.REGR_SXY, "regr_sxy({0}, {1})");
        add(OSQLOps.ROWNUMBER, "row_number()");
        add(OSQLOps.STDDEV, "stddev({0})");
        add(OSQLOps.STDDEVPOP, "stddev_pop({0})");
        add(OSQLOps.STDDEVSAMP, "stddev_samp({0})");
        add(OSQLOps.STDDEV_DISTINCT, "stddev(distinct {0})");
        add(OSQLOps.VARIANCE, "variance({0})");
        add(OSQLOps.VARPOP, "var_pop({0})");
        add(OSQLOps.VARSAMP, "var_samp({0})");
    ...
    protected void newLineToSingleSpace() {
        for (Class<?> cl : Arrays.<Class<?>>asList(getClass(), OSQLTemplates.class)) {
