  ...
  implements ISqlFormatRule
{
  ...
  private char outNewLineEnd = System.getProperty("line.separator")
    .charAt(System.getProperty("line.separator").length() - 1);
  ...
  public void addFunctions(String[] functions)
  {
    functions = StringUtils.toUpperCase(functions);
    this.functions = 
      ((String[])ArrayUtils.add(this.functions, functions, 
      new String[0]));
    Arrays.sort(this.functions);
  }
  ...
  public void addDataTypes(String[] dataTypes)
  {
    dataTypes = StringUtils.toUpperCase(dataTypes);
    this.dataTypes = 
      ((String[])ArrayUtils.add(this.dataTypes, dataTypes, 
      new String[0]));
    Arrays.sort(this.dataTypes);
  }
  ...
  public void subtractFunctions(String[] functions)
  {
    functions = StringUtils.toUpperCase(functions);
    this.functions = 
      ((String[])ArrayUtils.subtract(this.functions, 
  ...
  public void subtractDataTypes(String[] dataTypes)
  {
    dataTypes = StringUtils.toUpperCase(dataTypes);
    this.dataTypes = 
      ((String[])ArrayUtils.subtract(this.dataTypes, 
  ...
  public void setOutNewLineCode(int outNewLineCode)
  {
    ...
    this.outNewLineEnd = 
      this.outNewLineCodeStr.charAt(this.outNewLineCodeStr.length() - 1);
  }
