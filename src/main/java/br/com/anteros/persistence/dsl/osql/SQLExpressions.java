...
public final class SQLExpressions {
	...
	/**
	 * divides an ordered data set into a number of buckets indicated by expr and assigns the appropriate bucket number
	 * to each row
	 *
	 * @param num
	 * @return
	...
	/**
	 * computes the ratio of a value to the sum of a set of values. If expr evaluates to null, then the ratio-to-report
	 * value also evaluates to null.
	 *
	 * @return
	 */
